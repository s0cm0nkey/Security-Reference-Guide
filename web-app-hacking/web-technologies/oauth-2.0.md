...
1. OAuth token stealing: Changing redirect\_uri to attacker(.)com(Use IDN Homograph or common bypasses).
...
7. Open Redirection on another endpoint > Use it in redirect\_uri
...
11. Check if its leaking client\_secret parameter.
