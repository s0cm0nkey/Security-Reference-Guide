...
* Unauthorized SMTP user agent detection
  * By looking for unwanted user agents, we can detect unapproved outbound email applications. This is handy for alerting when an authorized system is compromised.
...
For domain enrichment, typo-squatting investigation, and dnstwist-style workflows, use the domain OSINT page.
