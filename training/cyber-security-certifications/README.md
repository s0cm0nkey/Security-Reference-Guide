...
* [https://learn.microsoft.com/en-us/credentials/](https://learn.microsoft.com/en-us/credentials/)
...
* [CompTIA Cloud +](https://www.comptia.org/certifications/cloud) - Learn the basic skills to deploy, optimize, and protect mission-critical applications and data storage. The next step beyond this should be to focus on certs for the cloud platform of your choice.
  * [Exam Objectives](https://partners.comptia.org/docs/default-source/resources/comptia-cloud-cv0-003-exam-objectives-\(1-0\))
...
* [Blue Team Level 1](https://securityblue.team/why-btl1/) - New to the certification scene, Security Blue Team has created a certification aimed at new or aspiring infosec professionals. This certification course will teach: Analysing and responding to phishing attacks, Performing forensics investigations to collect and analyse digital evidence, Using a SIEM platform to investigate malicious activity, Log and network traffic analysis including malware infections, Conducting threat actor research, and much more!
  * [Course Syllabus](https://securityblue.team/why-btl1/)
...
* [GIAC Exploit Researcher and Advanced Penetration Tester (GXPN)](https://www.giac.org/certifications/exploit-researcher-advanced-penetration-tester-gxpn/) - The GIAC Exploit Researcher and Advanced Penetration Tester certification validates a practitioner's ability to find and mitigate significant security flaws in systems and networks. GXPN certification holders have the skills to conduct advanced penetration tests and model attacker behavior to improve system security.
* [Offensive Security Certified Professional (OSCP)](https://www.offsec.com/courses/pen-200/)

{% content-ref url="oscp.md" %}
[oscp.md](oscp.md)
{% endcontent-ref %}
