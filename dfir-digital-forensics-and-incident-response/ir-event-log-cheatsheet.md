...
The embedded Sysmon cheat sheet is a useful legacy reference. Check the current Sysmon documentation and your deployed configuration because event schemas and coverage change over time.
